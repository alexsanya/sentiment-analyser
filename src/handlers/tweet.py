...
async def analyze_tweet_with_trump_zelenskyy(tweet_output: TweetOutput) -> AnalysisResult:
    """
    Analyze tweet content using Trump-Zelenskyy meeting workflow.
    ...
    """
    try:
        logger.info("Starting analysis with Trump-Zelenskyy workflow")
        
        # Use the new Trump-Zelenskyy workflow
        analysis_result = await analyze_with_trump_zelenskyy_workflow(
        ...
        logger.info(
            "Trump-Zelenskyy analysis completed",
        ...
        logger.error("Trump-Zelenskyy analysis failed", error=str(e))
...
async def handle_tweet_event_async(tweet_data: Dict[str, Any]) -> TweetProcessingResult:
    """Process tweet data with Trump-Zelenskyy meeting analysis and return transformed result.
    ...
    try:
        ...
        # Perform Trump-Zelenskyy analysis
        analysis_result = await analyze_tweet_with_trump_zelenskyy(transformed_data)
        ...
        logger.error(
            "Error processing tweet data with Trump-Zelenskyy analysis",
            error=str(e),
